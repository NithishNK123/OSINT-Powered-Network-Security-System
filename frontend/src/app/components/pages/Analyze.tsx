...
// Simplified mock data visualization since recharts can be tricky without proper setup
      ...
      {showResult ? (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="mb-4 text-foregroung font-semibold">Open Ports Risk Analysis</h3>
            ...
            <div className="glass-card rounded-xl p-6 border border-[var(--cyber-purple)]/50 bg-gradient-to-br from-[var(--cyber-purple)]/5 to-transparent">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="text-foreground mb-2 font-semibold">AI Threat Explanation</h4>
          ...
          <div className="space-y-6">
            <div className="glass-card rounded-xl p-6 flex flex-col items-center justify-center text-center">
              <h3 className="mb-6 text-foreground font-semibold">Threat Score</h3>
              
              {/* Circular Threat Score Indicator */}
              <div className="relative w-48 h-48 flex items-center justify-center mb-6">
                <div className="absolute inset-0 rounded-full border-8 border-white/5"></div>
                <div className="absolute inset-0 rounded-full border-8 border-[var(--cyber-red)] border-t-transparent border-l-transparent transform -rotate-45" style={{clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)'}}></div>
                <div className="flex flex-col items-center">
                   <div className="text-4xl font-bold text-[var(--cyber-red)]">{mockAnalysisResult.threatScore}</div>
                   <div className="text-xs text-muted-foreground mt-1">/ 100</div>
                </div>
              </div>
              
              <div className="p-4 bg-white/5 rounded-lg w-full text-left">
                <div className="flex items-center gap-2 mb-2">
                  <TrendingUp className="w-4 h-4 text-[var(--cyber-red)]" />
                  <span className="text-sm text-foreground font-medium">Risk Assessment</span>
                </div>
            ...
            {/* Quick Actions */}
            <div className="glass-card rounded-xl p-6">
              <h3 className="mb-4 text-foreground font-semibold">Quick Actions</h3>
              <div className="space-y-3">
                <button className="w-full px-4 py-3 bg-[var(--cyber-red)]/20 border border-[var(--cyber-red)]/50 text-[var(--cyber-red)] rounded-lg hover:bg-[var(--cyber-red)]/30 transition-colors font-medium">
                  Block IP Address
                </button>
                <div className="grid grid-cols-2 gap-3">
                   <button className="w-full px-4 py-3 bg-white/5 border border-border/30 text-foreground rounded-lg hover:bg-white/10 transition-colors text-sm">
                    Add Watchlist
                   </button>
                   <button className="w-full px-4 py-3 bg-white/5 border border-border/30 text-foreground rounded-lg hover:bg-white/10 transition-colors text-sm">
                    Generate Report
        ...
        /* Empty State */
        <div className="glass-card rounded-xl p-12 text-center border-dashed border-2 border-border/30">
