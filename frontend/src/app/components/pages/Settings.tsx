      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <div className="p-5 bg-gradient-to-br from-[var(--cyber-blue)]/5 to-[var(--cyber-purple)]/5 rounded-lg border border-border/30 hover:border-border/60 transition-all">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={toggleTheme}
              className={`relative inline-flex items-center h-9 w-20 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-lg ml-6 ${
                theme === 'dark' 
            ...
            >
              <span
                className={`inline-flex items-center justify-center w-7 h-7 transform rounded-full bg-white shadow-lg transition-all duration-300 ${
