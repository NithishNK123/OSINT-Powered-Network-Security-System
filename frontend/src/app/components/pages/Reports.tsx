import { Download, FileText, Calendar, TrendingUp, Upload, Eye, FileDown, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="space-y-4">
          {reportsData.map((report) => (
            <div
              ...
              className={`p-4 bg-white/5 rounded-lg border cursor-pointer transition-all group ${
      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <button 
            ...
            className={`p-5 rounded-lg border transition-all flex flex-col items-center gap-3 ${
              selectedReport
