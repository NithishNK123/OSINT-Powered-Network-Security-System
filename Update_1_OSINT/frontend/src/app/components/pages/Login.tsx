        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="glass-card rounded-2xl p-8 w-full max-w-md relative z-10 border-2 border-border/30">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[var(--cyber-blue)] to-[var(--cyber-purple)] rounded-2xl mb-4 shadow-lg shadow-[var(--cyber-blue)]/50">
                        <Shield className="w-8 h-8 text-white" />
                    </div>
                    <h1 className="text-3xl bg-gradient-to-r from-[var(--cyber-blue)] to-[var(--cyber-purple)] bg-clip-text text-transparent mb-2">
                        OSINT ADVANTAGE
                    </h1>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                                ...
                                <div className="absolute top-full left-0 right-0 mt-2 bg-background border border-border/50 rounded-lg shadow-xl overflow-hidden z-50">
                                    {roles.map((r) => (
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left transition-all hover:bg-white/10 border-l-2 ${role === r.value
                                        ...
                                        >
                                            ...
                                            <p className="text-xs text-muted-foreground ml-5">{r.description}</p>
                                        </button>
                                    ))}
                                </div>
                            )}
                    ...
                    {/* Error Message */}
                    {error && (
                        <div className="p-3 bg-[var(--cyber-red)]/10 border border-[var(--cyber-red)]/30 rounded-lg">
                            <p className="text-sm text-[var(--cyber-red)]">{error}</p>
                        </div>
                    )}
                    ...
                    <button
                        type="submit"
                        className="w-full px-6 py-3 bg-gradient-to-r from-[var(--cyber-blue)] to-[var(--cyber-purple)] text-white rounded-lg hover:shadow-lg hover:shadow-[var(--cyber-blue)]/50 transition-all transform hover:scale-[1.02]"
                    >
                        Login to Dashboard
                    </button>
                </form>
                ...
                <div className="mt-6 pt-6 border-t border-border/30">
                    <div className="p-3 bg-[var(--cyber-blue)]/5 border border-[var(--cyber-blue)]/20 rounded-lg">
                        <p className="text-xs text-muted-foreground text-center leading-relaxed">
                            <span className="text-[var(--cyber-blue)]">Demo Credentials:</span> Use any username and password to login with selected role
                        </p>
                    </div>
                </div>
            </div>
